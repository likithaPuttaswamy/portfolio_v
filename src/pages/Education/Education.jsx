...
const EducationSection = () => {
  ...
  const educationData = [
    {
      degree: "MSc in Advance Mechanical Engineering With Industrial Placement Program",
      school: "University of Strathclyde",
      mascot: "📘",
      year: "2024 - Present",
      achievements: ["Present"],
      skills: ["Engineering Simulations & Analysis", "Computational Fluid Dynamics", "CAD Design", "Thermodynamics & Heat Transfer"],
      description:
        "Focused on core mechanical engineering principles with emphasis on simulation, design, and applied research through advanced laboratory and computational work."
    },
    {
